...
export function ChequeLoggerModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-6">
      <div ref={containerRef} role="dialog" aria-modal="true" aria-labelledby="cheque-logger-title" className="lve-panel bg-white w-[1200px] max-w-full max-h-[90vh] flex flex-col">
        <header className="lve-panel-header flex items-center justify-between">
          <span id="cheque-logger-title">Cheque Logger</span>
          <button
            type="button"
