...
export function CompletionCheckerModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 p-6">
      <div ref={containerRef} role="dialog" aria-modal="true" aria-labelledby="completion-checker-title" className="lve-panel bg-white w-[640px] max-w-full max-h-[85vh] flex flex-col">
        <header className="lve-panel-header flex items-center justify-between">
          <span id="completion-checker-title">Completion Checker</span>
          <button
            type="button"
