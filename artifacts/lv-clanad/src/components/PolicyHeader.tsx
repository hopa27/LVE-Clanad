...
export function PolicyHeader() {
  ...
  return (
    <div className="lve-panel mb-6 p-4 flex flex-wrap items-center gap-3">
      ...
      {planCode === "87" || planCode === "84" || planCode === "90" || planCode === "51" || planCode === "83" || planCode === "621" || planCode === "76" || planCode === "62a" || planCode === "611" || planCode === "52" ? (
      ...
      {planCode === "84" || planCode === "51" || planCode === "83" || planCode === "62a" || planCode === "611" ? (
