...
export function TabBar({
  ...
  const visibleTabs =
    planCode === "611"
      ? TABS.filter((t) => t.key !== "contacts" && t.key !== "contacts2" && t.key !== "events" && t.key !== "maturities" && t.key !== "loa")
      : planCode === "87" || planCode === "84" || planCode === "90" || planCode === "51" || planCode === "621" || planCode === "62a"
