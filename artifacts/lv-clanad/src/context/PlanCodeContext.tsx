...
export type PlanCodeVersion = "0" | "87" | "84" | "90" | "51" | "83" | "82" | "80" | "621" | "76" | "76z" | "62a" | "611" | "52" | "61a";
...
export const PLAN_CODE_VERSIONS: {
  ...
  { code: "80",  planType: "PRP",    description: "Version 80 — PRP (Status M)" },
  ...
  { code: "76z", planType: "ICFP",   description: "Version 76z — ICFP (Status Z)" },
...
export function PlanCodeProvider({ children }: { children: ReactNode }) {
  const [planCode, setPlanCode] = useState<PlanCodeVersion>("611");
  const [surname, setSurname] = useState<string>("Testssbaadad");
  const [policyRef, setPolicyRef] = useState<string>("100303");
  return (
