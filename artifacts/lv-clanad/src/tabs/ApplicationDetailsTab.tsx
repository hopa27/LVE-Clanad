      ...
      <div className="panel panel-body grid grid-cols-1 lg:grid-cols-4 gap-x-6">
        ...
        <div>
          <Field label="Set Up Date:">
            <DatePicker
              value={isPlan87 ? "15/05/2026" : isPlan84 ? "17/03/2010" : isPlan90 ? "25/06/2025" : isPlan51 ? "22/01/2008" : isPlan83 ? "27/07/2015" : isPlan621 ? "03/01/2008" : ""}
          ...
          <Field label={isPlan90 ? "MCP Start Date:" : "Received Date:"}>
            <DatePicker
              value={isPlan84 ? "17/03/2010" : isPlan90 ? "25/06/2025" : isPlan51 ? "21/01/2008" : isPlan83 ? "24/07/2015" : isPlan621 ? "27/12/2007" : ""}
              placeholder={isCompact ? "" : "DBEditAPPLIC"}
            />
          </Field>
          <Field label={isPlan90 ? "Payment Date:" : "Start Date:"}>
            <DatePicker
              value={isPlan87 ? "15/05/2026" : isPlan84 ? "31/03/2010" : isPlan90 ? "28/05/2025" : isPlan51 ? "28/01/2008" : isPlan83 ? "14/08/2015" : isPlan621 ? "07/01/2008" : ""}
              placeholder={isCompact ? "" : "edtStartdate"}
              disabled={isPlan84 || isPlan90 || isPlan51 || isPlan83 || isPlan621}
            />
          </Field>
          {!isCompact && !isPlan51 && !isPlan83 && !isPlan621 && (
            <>
          ...
          {!isPlan84 && !isPlan90 && !isPlan51 && !isPlan621 && (
          ...
          <Field label="IFA Payment Date:">
            <DatePicker
              value={isPlan84 ? "13/04/2010 10" : isPlan90 ? "07/07/2025 07" : isPlan51 ? "05/02/2008 09" : isPlan83 ? "24/08/2015 10" : isPlan621 ? "22/01/2008 14" : ""}
              placeholder={isCompact ? "" : "DBEdit13"}
              disabled={isPlan84 || isPlan90 || isPlan51 || isPlan83 || isPlan621}
            />
          </Field>
          <Field label="PostADay:"><Checkbox checked={isPlan87 || isPlan84 || isPlan51 || isPlan83 || isPlan621} /></Field>
        ...
        <div>
          {!isPlan87 && (
            <Field label="Special Status:">
              <TextInput value={isPlan84 || isPlan90 || isPlan51 || isPlan83 ? "" : isPlan621 ? "G" : "DBSp"} disabled />
            </Field>
          )}
          {!isPlan84 && !isPlan90 && !isPlan51 && !isPlan621 && (
          ...
          <Field label="Status:">
            <TextInput value={isPlan87 ? "P" : isPlan84 || isPlan90 ? "L" : isPlan51 ? "Q" : isPlan83 ? "W" : isPlan621 ? "I" : "status"} disabled />
          </Field>
          {!isPlan87 && (
            <Field label="Suspended:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 || isPlan621 ? "N" : isPlan51 ? "Y" : "DBSu"} disabled />
            </Field>
          )}
          <Field label="Days Since Application:">
            <TextInput
              value={isPlan87 ? "" : isPlan84 ? "5912" : isPlan90 ? "334" : isPlan51 ? "6707" : isPlan83 ? "3966" : isPlan621 ? "6738" : "dbday"}
              disabled
            />
          </Field>
          {isPlan621 && (
        ...
        {!isPlan87 && (
          <div>
            ...
            <Field label="Life One Dead:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 ? "" : isPlan51 || isPlan621 ? "Y" : "DBLifeOneDe"} disabled />
            </Field>
            <Field label="Life Two Dead:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 || isPlan621 ? "" : "DBLifeTwoDe"} disabled />
            </Field>
            <Field label="Completed:">
              <TextInput
                value={isPlan84 ? "13/04/2010" : isPlan90 ? "02/07/2025" : isPlan51 ? "05/02/2008" : isPlan83 ? "24/08/2015" : isPlan621 ? "22/01/2008" : "DBCompeted"}
                disabled
              />
            </Field>
            <Field label="Closed:">
              <TextInput value={isPlan84 || isPlan90 || isPlan51 || isPlan83 || isPlan621 ? "" : "DBClosed"} disabled />
            </Field>
            {!isPlan84 && !isPlan90 && !isPlan83 && (
              <>
                <Field label="Age at death:">
                  <TextInput value={isPlan51 || isPlan621 ? "" : "edAge"} disabled />
                </Field>
                ...
                <div className="mt-2">
                  <button type="button" className="lve-btn lve-btn-sm" disabled={isPlan51}>
                    Create payment...
                  </button>
                </div>
              </>
        ...
        <div>
          ...
          <Field label="Last amended by:">
            <TextInput
              value={isPlan87 ? "SAIMEENAKSHINA" : isPlan84 ? "LOPVH" : isPlan90 ? "LV66664" : isPlan51 ? "LOPSL2" : isPlan83 ? "LV66656" : isPlan621 ? "LV67320" : "DBEdit18"}
              disabled
            />
          </Field>
          {!isPlan84 && !isPlan90 && !isPlan51 && !isPlan621 && (
          ...
          <Field label="Rates Ok'd by:">
            <TextInput value={isCompact || isPlan51 || isPlan83 || isPlan621 ? "" : "DBEdit7"} disabled />
          </Field>
          <Field label="Paykey:">
            <TextInput
              value={isPlan87 ? "1023693" : isPlan84 ? "899032" : isPlan90 ? "1018055" : isPlan51 ? "887324" : isPlan83 ? "956314" : isPlan621 ? "100004.1" : "DBEdit20"}
              disabled
            />
          </Field>
          <Field label="Policy No:">
            <TextInput
              value={isPlan87 ? "233451" : isPlan84 ? "111834" : isPlan90 ? "227813" : isPlan51 ? "100188" : isPlan83 ? "166092" : isPlan621 ? "100004.1" : "DBEdit24"}
              disabled
            />
          </Field>
          {!isPlan90 && !isPlan51 && !isPlan621 && (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Section title="Correspondence Details">
            <Field label="Correspond Name:">
              <TextInput
                value={isPlan87 ? "Dr T Uggiu" : isPlan84 ? "Testmtbbbide" : isPlan90 ? "Testmtcchibd" : isPlan51 ? "Testmdbaabii" : isPlan621 ? "Testfrbaaaae.b" : "correspname"}
              />
            </Field>
            <Field label="Salutation Name:">
              <TextInput
                value={isPlan87 ? "Dr Uggiu" : isPlan84 ? "Testmtbbbide" : isPlan90 ? "Testmtcchibd" : isPlan51 ? "Testmdbaabii" : isPlan621 ? "Testfrbaaaae.b" : "salname"}
              />
            </Field>
            <Field label="Telephone:">
              <TextInput value={isPlan87 ? "" : isPlan84 ? "01632 391651" : isPlan90 ? "" : isPlan51 ? "016324162140" : isPlan621 ? "01632 329 783" : "anntele"} />
            </Field>
            <Field label="E-mail:">
              <TextInput
                value={isPlan87 || isPlan84 || isPlan51 ? "" : isPlan90 ? "zzzzzz99@zzzzzzz.zz.zz" : isPlan621 ? "zzzzz@zzzzzzzz.zzz" : "DBEditPH_EMAIL"}
              />
            </Field>
          </Section>
          ...
          <Section title="Correspondence Address">
            ...
            <Field label="Postcode:">
              <TextInput
                value={isPlan87 ? "OP9 0OP" : isPlan84 ? "ZE99 9AB" : isPlan90 ? "KI99 9AB" : isPlan51 ? "LE99 9AB" : isPlan621 ? "QU99 9AB" : "phpc"}
              />
            </Field>
            <Field label="Country:">
              <SelectInput
                value={isPlan90 || isPlan51 || isPlan621 ? "United Kingdom" : "cmbCountry"}
