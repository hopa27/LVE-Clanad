      ...
      <div className="panel panel-body grid grid-cols-1 lg:grid-cols-4 gap-x-6">
        ...
        <div>
          <Field label="Set Up Date:">
            <DatePicker
              value={isPlan87 ? "15/05/2026" : isPlan84 ? "17/03/2010" : isPlan90 ? "25/06/2025" : isPlan51 ? "22/01/2008" : isPlan83 ? "27/07/2015" : ""}
          ...
          <Field label={isPlan90 ? "MCP Start Date:" : "Received Date:"}>
            <DatePicker
              value={isPlan84 ? "17/03/2010" : isPlan90 ? "25/06/2025" : isPlan51 ? "21/01/2008" : isPlan83 ? "24/07/2015" : ""}
              placeholder={isCompact ? "" : "DBEditAPPLIC"}
            />
          </Field>
          <Field label={isPlan90 ? "Payment Date:" : "Start Date:"}>
            <DatePicker
              value={isPlan87 ? "15/05/2026" : isPlan84 ? "31/03/2010" : isPlan90 ? "28/05/2025" : isPlan51 ? "28/01/2008" : isPlan83 ? "14/08/2015" : ""}
              placeholder={isCompact ? "" : "edtStartdate"}
              disabled={isPlan84 || isPlan90 || isPlan51 || isPlan83}
            />
          </Field>
          {!isCompact && !isPlan51 && !isPlan83 && (
            <>
          ...
          <Field label="IFA Payment Date:">
            <DatePicker
              value={isPlan84 ? "13/04/2010 10" : isPlan90 ? "07/07/2025 07" : isPlan51 ? "05/02/2008 09" : isPlan83 ? "24/08/2015 10" : ""}
              placeholder={isCompact ? "" : "DBEdit13"}
              disabled={isPlan84 || isPlan90 || isPlan51 || isPlan83}
            />
          </Field>
          <Field label="PostADay:"><Checkbox checked={isPlan87 || isPlan84 || isPlan51 || isPlan83} /></Field>
        ...
        <div>
          {!isPlan87 && (
            <Field label="Special Status:">
              <TextInput value={isPlan84 || isPlan90 || isPlan51 || isPlan83 ? "" : "DBSp"} disabled />
            </Field>
          )}
          {!isPlan84 && !isPlan90 && !isPlan51 && (
          ...
          <Field label="Status:">
            <TextInput value={isPlan87 ? "P" : isPlan84 || isPlan90 ? "L" : isPlan51 ? "Q" : isPlan83 ? "W" : "status"} disabled />
          </Field>
          {!isPlan87 && (
            <Field label="Suspended:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 ? "N" : isPlan51 ? "Y" : "DBSu"} disabled />
            </Field>
          )}
          <Field label="Days Since Application:">
            <TextInput
              value={isPlan87 ? "" : isPlan84 ? "5912" : isPlan90 ? "334" : isPlan51 ? "6707" : isPlan83 ? "3966" : "dbday"}
              disabled
            />
          </Field>
          {!isCompact && !isPlan51 && !isPlan83 && (
        ...
        {!isPlan87 && (
          <div>
            ...
            <Field label="Life One Dead:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 ? "" : isPlan51 ? "Y" : "DBLifeOneDe"} disabled />
            </Field>
            <Field label="Life Two Dead:">
              <TextInput value={isPlan84 || isPlan90 || isPlan83 ? "" : "DBLifeTwoDe"} disabled />
            </Field>
            <Field label="Completed:">
              <TextInput
                value={isPlan84 ? "13/04/2010" : isPlan90 ? "02/07/2025" : isPlan51 ? "05/02/2008" : isPlan83 ? "24/08/2015" : "DBCompeted"}
                disabled
              />
            </Field>
            <Field label="Closed:">
              <TextInput value={isPlan84 || isPlan90 || isPlan51 || isPlan83 ? "" : "DBClosed"} disabled />
            </Field>
            {!isPlan84 && !isPlan90 && !isPlan83 && (
              <>
                <Field label="Age at death:">
                  <TextInput value={isPlan51 ? "58" : "edAge"} disabled />
                </Field>
        ...
        <div>
          ...
          <Field label="Last amended by:">
            <TextInput
              value={isPlan87 ? "SAIMEENAKSHINA" : isPlan84 ? "LOPVH" : isPlan90 ? "LV66664" : isPlan51 ? "LOPSL2" : isPlan83 ? "LV66656" : "DBEdit18"}
              disabled
            />
          </Field>
          {!isPlan84 && !isPlan90 && !isPlan51 && (
          ...
          <Field label="Rates Ok'd by:">
            <TextInput value={isCompact || isPlan51 || isPlan83 ? "" : "DBEdit7"} disabled />
          </Field>
          <Field label="Paykey:">
            <TextInput
              value={isPlan87 ? "1023693" : isPlan84 ? "899032" : isPlan90 ? "1018055" : isPlan51 ? "887324" : isPlan83 ? "956314" : "DBEdit20"}
              disabled
            />
          </Field>
          <Field label="Policy No:">
            <TextInput
              value={isPlan87 ? "233451" : isPlan84 ? "111834" : isPlan90 ? "227813" : isPlan51 ? "100188" : isPlan83 ? "166092" : "DBEdit24"}
              disabled
            />
          </Field>
          {!isPlan90 && !isPlan51 && (
