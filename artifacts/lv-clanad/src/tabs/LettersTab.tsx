...
const LETTERS = [
  ...
  "Claim Form",
  "Completion Pack",
  "Death - Claim Completion Letter",
  "Death - Dependant Acknowledgement Letter",
  "Death - Initial Response Letter",
  "Disclosure Check",
  "Disclosure Check Payment Letter",
  "Divorce - Initial Response Letter",
  "Failed Disclosure Check",
  "IFA Acceptance Pack",
...
const LETTER_DIST: Record<string, DistConfig> = {
  ...
  "Failed Disclosure Check":               { print: true,  fax: false, email: false, sendTo: { client: true,  ifa: false, ceding: false, other: false } },
