    ...
    <div className="columns-1 lg:columns-3 gap-4 [&>section]:break-inside-avoid [&>section]:mb-4">
      <Section title="Policy Details">
        ...
        <Field label="Tax Code:">
          <div className="flex items-center gap-3">
            <div className="w-32">
              <TextInput value={isPlan87 ? "1257L*" : isPlan84 ? "1257L*" : isPlan90 ? "NT" : isPlan51 ? "1257L" : isPlan82 ? "1257L" : isPlan80 ? "1123L" : isPlan83 ? "125L" : isPlan621 ? "1257L" : isPlan76 ? "" : isPlan76z ? "" : isPlan62a ? "960L" : isPlan611 ? "939L" : isPlan52 ? "939L" : isPlan61a ? "BR" : "DBTAXC"} />
            </div>
        ...
        {(!isPreset || isPlan90) && !isPlan51 && !isPlan80 && !isPlan83 && !isPlan82 && !isPlan76 && !isPlan76z && !isPlan62a && !isPlan611 && !isPlan621 && !isPlan52 && !isPlan61a && (
          <>
        ...
        <Field label="ReAssurance Premium:">
          <TextInput
            value={isPlan87 ? "60000" : isPlan84 ? "12209.38" : isPlan90 ? "" : isPlan51 ? "5364.39" : isPlan82 ? "12834.92" : isPlan80 ? "18544.54" : isPlan83 ? "45275.68" : isPlan621 ? "23946.79" : isPlan76 ? "26377.2" : isPlan76z ? "38218.79" : isPlan62a ? "65142" : isPlan611 ? "0" : isPlan52 ? "0" : isPlan61a ? "4082.21" : "dbreassprem"}
          />
        </Field>
        <Field label="ReAssurer:">
          <TextInput value={isPreset || isPlan51 || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan61a ? "RGA 1" : isPlan611 || isPlan52 ? "None" : "dbReassurer"} />
        </Field>
        <Field label="Evidence of Age:">
          <TextInput value={isPlan87 || isPlan52 ? "N" : isPlan84 || isPlan90 || isPlan51 || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan61a ? "Y" : "DB"} />
        </Field>
        <Field label="Advice Type:">
          <div className="flex items-center gap-2">
            <div className="flex-1 min-w-0">
              <SelectInput
                value={isPreset || isPlan51 || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan611 || isPlan52 || isPlan61a ? "Independent" : isPlan62a ? "Non advised" : ""}
                options={
                  isPreset || isPlan51 || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan611 || isPlan52 || isPlan61a
        ...
        <Field label="Scheme Pension:">
          <SelectInput
            value={isPreset || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan52 ? "No" : isPlan51 || isPlan611 || isPlan61a ? "Unknown" : "DBLookupComl"}
            options={isPreset || isPlan80 || isPlan83 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan52 ? ["No", "Yes"] : isPlan51 || isPlan611 || isPlan61a ? ["Unknown", "No", "Yes"] : ["DBLookupComl", "No", "Yes"]}
          />
        </Field>
      ...
      <Section title="IFA Contact Details">
        <Field label="Name:">
          <TextInput
            value={
              ...
              : isPlan621 ? "Blandford Forum Financial Services"
        ...
        <Field label="District:">
          <TextInput value={isPreset || isPlan51 || isPlan83 || isPlan62a || isPlan52 || isPlan61a || isPlan76z ? "" : isPlan80 ? "Newburn Riverside" : isPlan621 ? "Blandford Heights Ind. E" : isPlan611 ? "Heather" : isPlan76 ? "West Way" : "DBEdDistrict"} disabled />
        </Field>
        <Field label="County:">
          <TextInput
            value={
      ...
      <div className="mb-4 px-1 space-y-3 break-inside-avoid">
        ...
        <Field label="Serious ill health:">
          <DatePicker
            value={isPreset || isPlan51 || isPlan80 || isPlan82 || isPlan83 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "" : "DbEdSeriou"}
            placeholder={isPreset || isPlan51 || isPlan80 || isPlan82 || isPlan83 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "" : "DbEdSeriou"}
          />
        </Field>
      </div>
      ...
      <Section title="IFA Details">
        ...
        <Field label={isPlan84 || isPlan90 || isPlan51 || isPlan80 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "Comm. %:" : "Adviser Charge %:"}>
          <TextInput
            value={isPlan87 ? "" : isPlan84 ? "2" : isPlan90 ? "0" : isPlan51 ? "2" : isPlan82 ? "3" : isPlan80 ? "3" : isPlan83 ? "" : isPlan621 ? "5" : isPlan76 ? "4" : isPlan76z ? "4" : isPlan62a ? "3" : isPlan611 ? "1.3" : isPlan52 ? "1" : isPlan61a ? "1.3" : "edtAdviserChar"}
            disabled
          />
        </Field>
        <Field label={isPlan84 || isPlan90 || isPlan51 || isPlan80 || isPlan82 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "Commission:" : "Adviser Charge:"}>
          <TextInput
            value={isPlan87 ? "0" : isPlan84 ? "406.98" : isPlan90 ? "" : isPlan51 ? "176.81" : isPlan82 ? "641.75" : isPlan80 ? "927.23" : isPlan83 ? "0" : isPlan621 ? "1995.57" : isPlan76 ? "1758.48" : isPlan76z ? "2547.92" : isPlan62a ? "3257.1" : isPlan611 ? "47.72" : isPlan52 ? "324.03" : isPlan61a ? "88.45" : "edtAdviserChar"}
            disabled
          />
        </Field>
      ...
      {!isPlan87 && !isPlan84 && !isPlan80 && !isPlan82 && !isPlan90 && !isPlan51 && !isPlan621 && !isPlan76 && !isPlan76z && !isPlan62a && !isPlan611 && !isPlan52 && !isPlan61a && (
        <Section title="MPAA">
          <Field label=" ">
      ...
      <Section title="Agency Deceased">
        ...
        <Field label="Agency Ref:">
          <TextInput value={isPreset || isPlan51 || isPlan80 || isPlan83 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "" : "edtAgencyDecea"} disabled />
        </Field>
        <Field label="Agency Unique Ref:">
          <TextInput value={isPreset || isPlan51 || isPlan80 || isPlan83 || isPlan621 || isPlan76 || isPlan76z || isPlan62a || isPlan611 || isPlan52 || isPlan61a ? "" : "edtAgencyDecNo"} disabled />
        </Field>
